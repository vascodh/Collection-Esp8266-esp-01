    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "### Se puede utilizar un navegador web - PC o Telefono movil Ingresando en la URL la IP fija que se asginó al modulo\n### http://192.168.0.150 añadir a continuacion lo que queremos enviar... en este ejemplo sería \n# http://192.168.0.150/L7",
            "readonly": true
          },
          "position": {
            "x": -472,
        ...
        {
          "id": "b3f17cec-e902-4c33-8eb4-9e9114af5b55",
      ...
      "wires": [
        {
          "source": {
            "block": "b3f17cec-e902-4c33-8eb4-9e9114af5b55",
